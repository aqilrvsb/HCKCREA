      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <aside className="hidden lg:flex flex-col w-[272px] flex-shrink-0 border-r border-white/40 bg-white/55 backdrop-blur-2xl">
          ...
          <div className="px-5 pb-3">
            <div className="relative overflow-hidden rounded-2xl p-4 bg-gradient-to-br from-orange-50 via-white to-amber-50 border border-orange-100">
              ...
              <button
                ...
                className="mt-3 w-full py-2 rounded-lg bg-gradient-to-r from-orange-500 to-orange-600 text-white text-xs font-bold hover:scale-[1.02] transition-transform"
              >
                + Top Up
              </button>
            </div>
          ...
          <div className="px-5 pb-5 pt-2 border-t border-white/40">
            <div className="flex items-center gap-3 px-2 py-2 mb-3">
              <div className="w-9 h-9 rounded-full bg-gradient-to-br from-orange-300 to-orange-500 flex-shrink-0 ring-2 ring-white" />
        ...
        <main className="flex-1 min-w-0 flex flex-col">
          ...
          <div className="lg:hidden flex items-center justify-between px-5 py-4 border-b border-[var(--color-border)] bg-white/70 backdrop-blur-md">
            ...
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-violet-50 border border-orange-100">
              <Wallet className="w-3.5 h-3.5 text-violet-600" />
