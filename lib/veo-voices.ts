...
MODESTY LOCK (Malaysian-Muslim audience — applies to ALL personas regardless of hijab choice): Long sleeves only. Fully covered neckline — no cleavage, no V-necks low enough to expose chest. No short shorts, no mini skirts above the knee. No midriff exposure, no crop tops. No tank tops. No tight body-hugging fits. No shirtless / sleeveless characters. Hair MAY be visible (only if persona is non-hijab) but body STAYS COVERED. Modest casual / smart-casual silhouettes only.
